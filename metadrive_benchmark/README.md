# Mining MetaDrive implementation
...
```powershell
conda run -n metadrive python -m pytest metadrive_benchmark/tests -q -p no:cacheprovider
conda run -n metadrive python -m metadrive_benchmark.scripts.validate_formal_teacher
```
