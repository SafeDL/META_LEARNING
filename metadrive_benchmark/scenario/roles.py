"""Explicit adversary and SUT spawning."""
from __future__ import annotations

from typing import Any
import numpy as np

from sut_algorithms.metadrive.base import ControllerProfile, SUTAdapter
...
def spawn_sut(
    ...
    *,
    ...
    vehicle = manager.spawn_object(TrafficDefaultVehicle,
                                   vehicle_config={
