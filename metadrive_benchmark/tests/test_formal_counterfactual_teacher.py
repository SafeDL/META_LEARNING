...
from metadrive_benchmark.formal.counterfactual_teacher import CounterfactualTeacher
from metadrive_benchmark.formal.formal_counterfactual_teacher import (
    CONTINUATION_POLICIES,
    FormalCounterfactualTeacher,
    FormalTeacherEvaluation,
)
from metadrive_benchmark.formal.formal_calibrator import FormalEventCalibrator
from metadrive_benchmark.formal.state import TeacherWorld
from metadrive_benchmark.scripts.validate_formal_teacher import REPOSITORY_ROOT, _jaccard
...
def test_validator_resolves_the_repository_after_package_moves() -> None:
    assert (REPOSITORY_ROOT / "metadrive_benchmark" / "configs" / "formal_teacher.yaml").is_file()
