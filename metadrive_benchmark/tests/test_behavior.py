...
from metadrive_benchmark.mining.behavior import CutInBehavior
from metadrive_benchmark.training.runner import InnerActionPhase


def test_mining_behavior_tracks_one_prescribed_speed_without_sut_feedback() -> None:
...
def test_mining_behavior_does_not_change_a_prescribed_speed_for_maneuver_phase() -> None:
    behavior = CutInBehavior()
