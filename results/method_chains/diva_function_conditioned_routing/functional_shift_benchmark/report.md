...
| **Function-Conditioned DIVA** | **77.21%** |
| Function Oracle | 78.92% |

本文方法相对 AdaTE 提高20.20个百分点，相对DIVA提高30.35个百分点，达到功能
Oracle召回的97.83%。预测层面，K=10后的未查询严重度MSE由DIVA的0.11814
...
DIVA门控在历史失配时提供回退，但本基准的历史模块确实能解释目标，所以门控只带来
