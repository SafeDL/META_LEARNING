...
from highway_sim_env.data.generate_anchor_bank import FUNCTIONAL_MODES
...
from methods.detour_fusion.experiment import CONFIG, OUTPUT_DIR
from sut_algorithms.highway_env.idm_profiles import get_profile


RESULT_DIR = OUTPUT_DIR
METHOD = "DETOUR-Guided Risk Diagnosis"
