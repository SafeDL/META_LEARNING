...
```powershell
conda run -n metadrive python -m pytest methods/detour_fusion/tests -q -p no:cacheprovider

conda run -n metadrive python -m methods.detour_fusion.experiment

conda run -n metadrive python -m methods.detour_fusion.experiment --reuse-bank

conda run -n metadrive python -m methods.detour_fusion.replay

conda run -n metadrive python -m methods.detour_fusion.passing_experiment
```
