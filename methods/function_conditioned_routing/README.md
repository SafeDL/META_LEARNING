...
```powershell
conda run -n metadrive python -m pytest methods/function_conditioned_routing/tests -q -p no:cacheprovider

conda run -n metadrive python -m methods.function_conditioned_routing.experiment

conda run -n metadrive python -m methods.function_conditioned_routing.experiment --reuse-bank

conda run -n metadrive python -m methods.function_conditioned_routing.robustness

conda run -n metadrive python -m methods.function_conditioned_routing.replay
```
