"""Fold-local formal-event calibration for the analytic teacher."""
...
class FormalEventCalibrator:
    ...
    def fit(
        ...
        *,
        ...
        if not context_sizes or context_sizes[0] != 0 or tuple(sorted(
                set(context_sizes))) != context_sizes:
        ...
        for source_index in indexes:
            ...
            for context_size in context_sizes:
                ...
                label_rows.append(
                    formal_class_indexes(world.formal_scores[source_index, available]))
