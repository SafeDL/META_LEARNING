...
def _require_g1_pass(prior_path: str, logical_domain_id: str) -> None:
    ...
    if (report.get("schema") != "diva_source_loso_g1_v2"
...
def run(config_path: str,
        ...
        *,
        ...
        support_shots: int,
        algorithm_seed: int,
        method: str = "diva_diagnostic") -> dict:
    ...
    support_count = support_shots if method in {
        "diva_random_support", "diva_diagnostic", "target_only_gp"
    } else 0
    if method in {"random", "frozen_source_mean", "online_diva_k0"
