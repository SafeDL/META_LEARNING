...
from diva_metadrive.diva_ai.counterfactual_teacher import CounterfactualTeacher
from diva_metadrive.diva_ai.formal_counterfactual_teacher import (
    CONTINUATION_POLICIES,
    FormalCounterfactualTeacher,
    FormalTeacherEvaluation,
)
from diva_metadrive.diva_ai.formal_calibrator import FormalEventCalibrator
from diva_metadrive.diva_ai.state import TeacherWorld
from diva_metadrive.scripts.validate_diva_former import REPOSITORY_ROOT, _jaccard
...
def test_validator_resolves_the_repository_after_package_moves() -> None:
    assert (REPOSITORY_ROOT / "diva_metadrive" / "configs" / "diva_former.yaml").is_file()
