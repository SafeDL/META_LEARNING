...
RELATION_TYPES = ("successor", "predecessor", "left", "right", "merge", "split", "conflict",
                  "crossing", "route_membership")


def lane_relations(
        lane_indices: Iterable[tuple[object, object,
                                     int]]) -> dict[str, tuple[tuple[int, int], ...]]:
