...
def main() -> None:
    ...
    write_json(args.output, {"schema": GATE_SCHEMA, "taskbook_hash": taskbook_hash, "topology_audit": "pass", "integrity_audit": "pass", "heterogeneity_audit": "pass", "baseline_environment_steps": args.baseline_env_steps, "completed_baselines": completed})
    if set(completed) != set(PRETRAIN_BASELINE_NAMES):
        raise SystemExit("formal gate intentionally remains incomplete until all pre-training baselines finish")
