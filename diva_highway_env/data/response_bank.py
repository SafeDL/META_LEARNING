...
from diva_highway_env.data.generate_anchor_bank import generate_anchor_bank
from diva_highway_env.envs.cutin_env import CutInScenario, run_cutin_episode
from diva_highway_env.sut.idm_profiles import PROFILE_NAMES, SUTProfile, get_profile
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("results/diva_highway/response_bank.npz"),
    )
