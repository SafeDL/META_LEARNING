...
def default_registry() -> SUTRegistry:
    ...
    profiles = (
        ControllerProfile("idm_cautious", "idm", 0.80, 24.0, 3.0, 1.20, -2.0),
        ControllerProfile("idm_defensive", "idm", 0.90, 16.0, 2.2, 1.10, -3.0),
        ControllerProfile("idm_normal", "idm", 1.00, 9.0, 1.2, 1.20, -4.5),
        ControllerProfile("idm_assertive", "idm", 1.10, 3.0, 0.45, 1.80, -8.0),
        ControllerProfile("idm_fast_small_gap", "idm", 1.08, 5.0, 0.75, 1.50, -6.5),
        ControllerProfile("idm_late_response", "idm", 1.00, 7.0, 0.35, 0.75, -8.5),
    )
