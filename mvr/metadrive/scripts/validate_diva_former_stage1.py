...
def build_manifest(config_path: str | Path) -> dict[str, Any]:
    ...
    manifest = {
        ...
        "rebuild_command": (
            "conda run -n metadrive python -m mvr.metadrive.scripts.validate_diva_former_stage1 "
            "--config mvr/metadrive/configs/diva_former_stage1.yaml --phase teacher"
        ),
    }
...
def main() -> None:
    ...
    parser.add_argument("--config", default="mvr/metadrive/configs/diva_former_stage1.yaml")
