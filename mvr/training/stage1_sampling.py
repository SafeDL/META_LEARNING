...
class PretrainSceneSampler:
    ...
    # The SUT reaches the conflict 1.5 s after the adversary under nominal
    # speed.  This leaves a lawful base gap while giving the residual enough
    # pre-conflict runway to create or relieve interaction pressure.
    ...
    def _interaction_aligned_controls(
        ...
        offset = float(cls.interaction_eta_offset_s)
