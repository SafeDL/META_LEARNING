...
def build_manifest(config_path: str | Path) -> dict[str, Any]:
    ...
    v1_gate = root / "results/diva_former/cutin_g01/stage1/stage1_gate.json"
    manifest = {
        ...
        "implementation_sha256": {
            "formal_calibrator": _file_hash(root / "mvr/diva_ai/formal_calibrator.py"),
            "counterfactual_teacher_v2": _file_hash(
                root / "mvr/diva_ai/counterfactual_teacher_v2.py"
            ),
            "validator": _file_hash(
                root / "mvr/scripts/validate_diva_former_stage1_v2.py"
            ),
        },
        ...
        "rebuild_command": (
            ...
            "mvr.scripts.validate_diva_former_stage1_v2 "
            "--config mvr/configs/diva_former_stage1_v2.yaml"
        ),
    }
...
def main() -> None:
    ...
    parser.add_argument("--config", default="mvr/configs/diva_former_stage1_v2.yaml")
