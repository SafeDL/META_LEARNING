...
def build_manifest(config_path: str | Path) -> dict[str, Any]:
    ...
    manifest = {
        ...
        "rebuild_command": ("conda run -n metadrive python -m "
                            "metadrive_sim_env.scripts.validate_formal_teacher "
                            "--config metadrive_sim_env/configs/formal_teacher.yaml"),
    }
...
def main() -> None:
    ...
    parser.add_argument("--config", default="metadrive_sim_env/configs/formal_teacher.yaml")
