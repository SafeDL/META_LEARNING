...
def train(config_path: Path, bank_path: Path | None, output: Path) -> dict[str, object]:
    ...
    manifest = {
        ...
        "env_hash": sha256_file(Path("diva_highway_env/envs/cutin_env.py")),
        "oracle_hash": sha256_file(Path("diva_highway_env/envs/cutin_env.py")),
        "response_bank_code_hash": sha256_file(Path("diva_highway_env/data/response_bank.py")),
        "sut_profile_code_hash": sha256_file(Path("diva_highway_env/sut/idm_profiles.py")),
