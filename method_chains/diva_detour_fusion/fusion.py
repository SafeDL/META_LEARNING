"""Leakage-free DETOUR hierarchy transfer for the isolated DIVA-Mine fusion chain.
...
component in posterior-guided DIVA mining.  Target vulnerability values are
...
from diva_highway_env.diva.acquisition import (
    boundary_weight,
...
def detour_fused_diagnostic_mining(
    ...
    method falsifiable against both the K=0 DETOUR baseline and DIVA without
    hierarchy transfer.
    """
