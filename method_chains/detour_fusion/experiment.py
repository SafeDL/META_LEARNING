"""Run the pre-registered B=50 multi-function DETOUR/Mining comparison.
...
from target-specific Mining diagnosis and their two specified combinations.
"""
...
from method_chains.detour_fusion.config import FusionExperimentConfig
...
METHOD_COLORS = {
    ...
    "Risk Mining + Adaptation": "#4c78a8",
    "Risk Mining + DETOUR Hierarchy": "#59a14f",
    "DETOUR-Guided Risk Diagnosis": "#b279a2",
}
...
def run_loso_multifunction(bank: ResponseBank,
    ...
    """Evaluate only paper-grounded DETOUR/Mining methods under one B=50 budget."""
    config.validate()
