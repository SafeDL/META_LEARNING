"""Import, replay, and bounded execution stages for FBRT-Memory v2."""
...
from highway_env_benchmark.envs.fbrt_unified_env import (
        ...
        if set(evaluator) >= {row["scenario_id"] for row in candidates}:
            ...
            for method in METHODS:
                for repeat in range(RANDOM_REPEATS if method == "Random" else 1):
                    ...
                    first_queries, first_observations, first_cards, first_updates = run_selector_v2(
                    ...
                    next_queries, next_observations, next_pattern_cards, next_updates = run_selector_v2(
...
def evaluate_stage() -> dict:
    ...
    from method_chains.failure_memory_regression.report_v2 import generate_report
