...
from method_chains.failure_memory_regression.audit_v4 import _new_case
...
def test_ego_initial_state_is_a_seven_dimensional_search_input():
    config = yaml.safe_load(Path("configs/fbrt/ego_initial_state_audit_v3.yaml").read_text(
        encoding="utf-8"))
    ...
    queries, observations, _cards, updates = run_selector_v2(
