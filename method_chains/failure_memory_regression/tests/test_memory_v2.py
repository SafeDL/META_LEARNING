...
from method_chains.failure_memory_regression.bayes_model import fit_logistic
...
from method_chains.failure_memory_regression.selector_v2 import TargetOracle, run_selector_v2
from highway_env_benchmark.envs.fbrt_metrics import (
    longitudinal_bumper_clearance, time_to_collision,
)
from highway_env_benchmark.envs.fbrt_unified_env import FBRTUnifiedEnv
...
def test_scenario_id_does_not_change_feature_or_fixed_seed_selection():
    ...
    q1, *_ = run_selector_v2("Random", candidates, [], TargetOracle(bank1), 1, 7,
                             "target", mode="cross_agent")
    q2, *_ = run_selector_v2("Random", renamed_candidates, [], TargetOracle(bank2), 1, 7,
                             "target", mode="cross_agent")
...
def test_new_target_failure_creates_a_local_pattern_without_history():
    ...
    queries, observations, cards, updates = run_selector_v2(
...
def test_imported_target_labels_stay_evaluator_only_in_contextual_history():
    ...
    from method_chains.failure_memory_regression.experiment_v2 import _contextual_history
...
def test_cross_agent_seed_excludes_earlier_offline_replay_commits():
    from method_chains.failure_memory_regression.experiment_v2 import _cross_agent_seed_records
...
def test_cross_agent_summary_counts_collisions_without_a_parent_regression():
    from method_chains.failure_memory_regression.experiment_v2 import _summaries
