...
from method_chains.diva_function_conditioned_routing.benchmark import RELEASE_NAMES
from method_chains.diva_function_conditioned_routing.experiment import (
    severity_response,
)
...
def test_formal_artifacts_cover_every_declared_target_and_method() -> None:
    ...
    for directory, names in (
        ...
        assert "Function-Conditioned DIVA" in summary["mean_metrics"]
        for name in (
            "response_bank.npz",
            "mining_results.csv",
