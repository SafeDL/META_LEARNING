...
from archives.sac_scenario_mining.src.env import Stage1AdversarialMergeEnv
from archives.sac_scenario_mining.src.utils import load_config

DEFAULT_MODEL = PROJECT_ROOT / "results/sac_scenario_mining/merge_sac_seed2/best_model.zip"
DEFAULT_CONFIG = PROJECT_ROOT / "archives/sac_scenario_mining/configs/merge_sac.yaml"
