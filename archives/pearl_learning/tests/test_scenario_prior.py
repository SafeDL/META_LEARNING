...
from archives.pearl_learning.src.context_encoder import kl_diag_normal, product_of_gaussians_with_prior
from archives.pearl_learning.src.io import read_config
from archives.pearl_learning.src.scenario_encoder import DESCRIPTOR_FIELDS, DESCRIPTOR_SCHEMA, build_task_descriptor
...
class ScenarioPriorTests(unittest.TestCase):
    ...
    def test_static_descriptor_excludes_case_seed_and_hidden_rule(self) -> None:
        tasks = build_taskbook(read_config("archives/pearl_learning/configs/merge_method_flow_pilot.yaml"))["meta_train"]
