...
from archives.pearl_learning.src.benchmark_calibration import (
    apply_calibration_manifest,
    calibrate_thresholds,
    longitudinal_policy,
    resolve_calibration,
)
from archives.pearl_learning.src.casebook_v2 import solve_adversary_spawn
from archives.pearl_learning.src.causal_audit import (
    _actor_means,
...
from archives.pearl_learning.src.checkpoint import save_checkpoint
...
from archives.pearl_learning.scripts.audit_gate3_critic_replay_signal import transition_signal_summary
from archives.pearl_learning.scripts.recompute_gate3_verdict_v4 import recompute as recompute_gate3_v4
from archives.pearl_learning.src.critical import (
...
from archives.pearl_learning.src.mechanism_audit import (
    SCRIPTED_POLICIES,
...
from archives.pearl_learning.src.metrics import EpisodeMetrics
from archives.pearl_learning.src.observation import (
    DYNAMIC_OBSERVATION_DIM,
    DYNAMIC_OBSERVATION_SCHEMA,
    DYNAMIC_OBS_FIELDS,
)
from archives.pearl_learning.src.networks import LatentFiLMCritic, LatentGammaOnlyFiLMCritic
from archives.pearl_learning.src.pearl_agent import PEARLAgent
from archives.pearl_learning.src.replay import Transition, select_context_rows
from archives.pearl_learning.src.reward import compute_reward
from archives.pearl_learning.src.task_env import interpolated_conflict_entry_role
from archives.pearl_learning.src.taskbook import build_taskbook
from archives.pearl_learning.scripts.build_logical_order_mechanism_taskbook import derive_logical_order_taskbook


class MethodFlowV2Tests(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        cls.cfg = read_config("archives/pearl_learning/configs/merge_method_flow_pilot.yaml")
    ...
    def test_gate3_context_sampling_film_critic_config_changes_only_critic(self) -> None:
        round3 = read_config("archives/pearl_learning/configs/merge_method_flow_gate3_context_sampling.yaml")
        combined = read_config("archives/pearl_learning/configs/merge_method_flow_gate3_context_sampling_film_critic.yaml")
    ...
    def test_gate3_gamma_only_config_changes_only_critic(self) -> None:
        prior = read_config("archives/pearl_learning/configs/merge_method_flow_gate3_context_sampling_film_critic.yaml")
        combined = read_config(
            "archives/pearl_learning/configs/merge_method_flow_gate3_context_sampling_gamma_only_film_critic.yaml"
        )
        self.assertEqual(
    ...
    def test_variant_assertions_and_manifest_resume_guard(self) -> None:
        vanilla = read_config("archives/pearl_learning/configs/merge_method_flow_vanilla_pilot.yaml")
        structure = read_config("archives/pearl_learning/configs/merge_method_flow_pilot.yaml")
