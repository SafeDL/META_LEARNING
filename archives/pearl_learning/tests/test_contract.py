...
from archives.pearl_learning.src.adapters.base import MetaDriveAdapterBase
from archives.pearl_learning.src.context_encoder import ContextEncoder
from archives.pearl_learning.src.formal_validation import REQUIRED_PRETRAIN_BASELINES, verify_formal_validation
from archives.pearl_learning.src.posterior_adaptation_analysis import paired_method_effect, task_cluster_interval
from archives.pearl_learning.src.collector import Rollout
from archives.pearl_learning.src.evaluator import (
...
from archives.pearl_learning.src.io import read_config
from archives.pearl_learning.src.io import content_hash, write_json
from archives.pearl_learning.src.metrics import EpisodeMetrics, summarize
from archives.pearl_learning.src.pearl_agent import PEARLAgent
from archives.pearl_learning.src.pearl_trainer import _sample_tasks_without_replacement
from archives.pearl_learning.src.replay import TaskReplayBuffer, TaskReplayBuffers, Transition
from archives.pearl_learning.src.reward import (
    compute_reward,
    required_invalid_event_penalty,
    validate_reward_contract,
)
from archives.pearl_learning.src.observation import OBS_FIELDS, build_observation
from archives.pearl_learning.src.routes import RoutePolyline, wrap_to_pi
from archives.pearl_learning.src.task_spec import LogicalScenarioTaskSpec
from archives.pearl_learning.src.task_representation import (
    INTERACTION_OBSERVATION_FIELDS,
    INTERACTION_OBSERVATION_INDEXES,
    configure_disentangled_representation,
    representation_target,
)
from archives.pearl_learning.src.task_env import compose_route_tracking_action, target_contact_matches_rule
from archives.pearl_learning.src.taskbook import build_taskbook, taskbook_payload
from archives.pearl_learning.src.casebook import (
    build_casebook,
    physical_geometry_id,
    validate_casebook_disjoint,
)
from archives.pearl_learning.src.transferability import task_descriptor, transferability_report
from archives.pearl_learning.src.transferability_calibration import calibration_report
from archives.pearl_learning.src.transferability_decision import transferability_decision_report
from archives.pearl_learning.src.validation_freeze import freeze_validation_protocol, verify_validation_freeze
from archives.pearl_learning.src.support_selection import order_support_cases
from archives.pearl_learning.scripts.run_equal_budget_analysis import _case_groups, _selected_support_cases
from archives.pearl_learning.scripts.build_transferability_taskbook import extend_validation_catalog
from archives.pearl_learning.scripts.run_formal_baseline_suite import baseline_commands
from archives.pearl_learning.scripts.audit_task_heterogeneity import heterogeneity_report
from archives.pearl_learning.scripts.audit_integrity import _audit_taskbook
from archives.pearl_learning.scripts.run_baselines import (
    _bind_training_protocol,
    _latest_sac_checkpoint,
    _partial_payload,
    _partial_protocol_matches,
)
from archives.pearl_learning.scripts.select_per_task_sac_checkpoints import selection_key
from archives.pearl_learning.scripts.select_pooled_sac_checkpoint import aggregate_key
...
class ContractTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.config = read_config("archives/pearl_learning/configs/dense_pearl_baseline.yaml")
    ...
    def test_method_flow_pilot_activates_only_the_six_physical_tasks(self):
        config = read_config("archives/pearl_learning/configs/merge_method_flow_pilot.yaml")
    ...
    def test_adaptation_task_pairs_match_initial_conditions_but_not_ids_or_seeds(self):
        config = read_config("archives/pearl_learning/configs/posterior_adaptation_protocol.yaml")
